...
create table voucher (id int8 not null, version int8 not null, barcode_alpha varchar(10) not null, created_by_id int8 not null, date_created date not null, last_updated timestamp not null, sequence_number int4 not null, sold_at_id int8, status varchar(255) not null, valid_thru timestamp not null, validated_at_id int8, value float8 not null, voucher_request_id int8 not null, vouchers_idx int4, primary key (id));
