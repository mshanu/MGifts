...
create table invoice (id int8 not null, version int8 not null, created_by_id int8 not null, date_created timestamp not null, invoice_date timestamp not null, invoice_number varchar(255) not null, voucher_id int8 not null, primary key (id));
